...
export default function FreeServicesPage() {
  const freePortals = [
    ...
    {
      title: "Free Student Tools & CV Generator",
      subtitle: "CV Maker • Office Templates • Calculators",
      desc: "Free online tools for students and job seekers. Create professional CVs, practice MS Office shortcuts, and access financial productivity tools.",
